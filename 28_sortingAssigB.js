...
console.log(`==================================1.Sorted Employee by id in Descending order ===========================================`);
const arrayEmpId = arrayEmployees.sort((emp1,emp2) => {
...
console.log(`==================================2.Sorted Employee by department in Ascending order ===========================================`);
const arrayEmpDept = arrayEmployees.sort((emp1,emp2) => {
...
console.log(`==================================3.Sorted Employee by Salary in Descending order ===========================================`);
const arrayEmpSalary = arrayEmployees.sort((emp1,emp2) => {
